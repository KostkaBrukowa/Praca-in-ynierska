...
Dla każdego obiektu jest stworzony w każdym pakiecie katalog odpowiedzialny za obsługę danego obiektu. Jeżeli weźmiemy wcześniej wspomniany obiekt \emph{Grupa} to będzie stworzony dla niego odpowiednio:
\begin{itemize}
