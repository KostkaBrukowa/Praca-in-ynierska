...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Krok logowania]{{\includegraphics[width=0.45\textwidth]{presentation/login-login.jpg} }}%
    \qquad
    \subfloat[\centering Krok rejestracji]{{\includegraphics[width=0.45\textwidth]{presentation/login-register.jpg} }}%
...
\begin{figure}[h]%
    \centering
    \subfloat{{\includegraphics[width=0.45\textwidth]{presentation/responsive-sm.jpg} }}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Wydatek w stanie oczekującym]{{\includegraphics[width=0.31\textwidth]{presentation/expense-waiting.jpg} }}%
    \qquad
    \subfloat[\centering Wydatek rozpoczęty]{{\includegraphics[width=0.31\textwidth]{presentation/expense-in-progress.jpg} }}%
    \qquad
    \subfloat[\centering Wydatek zakończony]{{\includegraphics[width=0.31\textwidth]{presentation/expense-ended.jpg} }}%
    \qquad
    \subfloat[\centering Widok płatności i uczestników wydatku]{{\includegraphics[width=0.31\textwidth]{presentation/expense-bottom-view.jpg} }}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Formularz wydatku w dla wydarzenia]{{\includegraphics[width=0.31\textwidth]{presentation/expense-form-event.jpg} }}%
    \qquad
    \subfloat[\centering Formularz wydatku dla grupy]{{\includegraphics[width=0.31\textwidth]{presentation/expense-form-group.jpg} }}%
    \qquad
    \subfloat[\centering Formularz wydatku dla znajomych]{{\includegraphics[width=0.31\textwidth]{presentation/expense-form-friends.jpg} }}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Płatność niepotwierdzona]{{\includegraphics[width=0.31\textwidth]{presentation/payment-to-confirm.jpg} }}%
    \qquad
    \subfloat[\centering Potwierdzanie płatności]{{\includegraphics[width=0.31\textwidth]{presentation/payment-confirmation.jpg} }}%
    \qquad
    \subfloat[\centering Płatność potwierdzona]{{\includegraphics[width=0.31\textwidth]{presentation/payment-confirmed.jpg} }}%
    \qquad
    \subfloat[\centering Płatność gotowa do zapłaty]{{\includegraphics[width=0.31\textwidth]{presentation/payment-to-pay.jpg} }}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Lista wydarzeń]{{\includegraphics[width=0.45\textwidth]{presentation/event-event-list.jpg} }}%
    \qquad
    \subfloat[\centering Lista grup]{{\includegraphics[width=0.45\textwidth]{presentation/event-group-list.jpg} }}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Ekran wydarzenia]{{\includegraphics[width=0.45\textwidth]{presentation/event-event-view.jpg} }}%
    \qquad
    \subfloat[\centering Ekran grupy]{{\includegraphics[width=0.45\textwidth]{presentation/event-group-view.jpg} }}%
...
\begin{figure}[h!]%
    \centering
    \subfloat{{\includegraphics[width=0.31\textwidth]{presentation/event-form-p1.jpg} }}%
    \qquad
    \subfloat{{\includegraphics[width=0.31\textwidth]{presentation/event-form-p2.jpg} }}%
    \caption{Formularz w trybie typu \emph{Wydarzenie}}%
\end{figure}

\begin{figure}[h!]%
    \centering
    \subfloat{{\includegraphics[width=0.45\textwidth]{presentation/event-group-form.jpg} }}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Lista aktywności]{{\includegraphics[width=0.45\textwidth]{presentation/notification-list.jpg} \label{fig:notificationList} }}%
    \qquad
    \subfloat[\centering Lista aktywności z nowym powiadomieniem]{{\includegraphics[width=0.45\textwidth]{presentation/notification-list-new.jpg} \label{fig:notificationListNew}}}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Informacje użytkownika]{{\includegraphics[width=0.45\textwidth]{presentation/user-profile.jpg} }}%
    \qquad
    \subfloat[\centering Edycja numeru konta]{{\includegraphics[width=0.45\textwidth]{presentation/user-change-number.jpg}}}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Lista znajomych]{{\includegraphics[width=0.45\textwidth]{presentation/friend-list.jpg} }}%
    \qquad
    \subfloat[\centering Dialog dodawania nowych znajomych]{{\includegraphics[width=0.45\textwidth]{presentation/friend-add.jpg}}}%
...
\begin{figure}[h!]%
    \centering
    \subfloat[\centering Lista znajomych]{{\includegraphics[width=0.45\textwidth]{presentation/friend-view.jpg} }}%
\end{figure}
